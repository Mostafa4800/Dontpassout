                    ...
                    <PopUpPos>
                        <PopCard  height="auto">
                            {selectedCharecter.map((charecter) =>
                                <CharecterPopUp id={charecter.id} theSrc={charecter.image_front} søvnT={charecter.søvnT} søvnBehov={charecter.søvnBehov} setWrong={setWrongAnswerPop} evneForbrug={charecter.evneForbrug} />
                            )}
                        </PopCard>
                    </PopUpPos>
                </PopUpBackGround>
